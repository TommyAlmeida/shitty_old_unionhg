...
public class ColorScroll {
    ...
    public ColorScroll(ChatColor textColor, String str, String colorMid, String colorBefore, String colorAfter, boolean bold, boolean upperCaseMid, ScrollType scrollType) {
        this.str = str;
    ...
    public String Scroll(String text,int largura, int spaces){
        StringScroll ss = new StringScroll(text,32,0,'§');
        return ss.next();
    }
